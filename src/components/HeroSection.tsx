      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center max-w-4xl mx-auto">
          <h1 className="text-4xl md:text-6xl font-display font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-primary to-secondary">
            Advanced Tools for Memecoins
          </h1>
          <p className="text-lg md:text-xl text-gray-300 mb-8">
            Complete suite of tools for managing and analyzing your meme tokens.
            Maximize your opportunities with our professional solutions.
          </p>
          <div className="flex gap-4 justify-center">
            <Button size="lg" className="bg-primary text-background hover:bg-primary/90">
              Discover Tools <ArrowRight className="ml-2 h-4 w-4" />
            </Button>
